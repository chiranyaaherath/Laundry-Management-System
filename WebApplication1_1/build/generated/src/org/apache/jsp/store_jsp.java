...
public final class store_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(session.getAttribute("username")== null){
      ...
      out.write("        </nav>\n");
      out.write("\n");
      out.write("        <p class = \"heading\"><b>Store Section</b></p>\n");
      out.write("\n");
      out.write("        <form class = \"form_design\"  action = \"update\" method = \"post\">\n");
      out.write("\n");
 ...
 try {
      ...
      out.write("                    <br><br>\n");
      out.write("\n");
      out.write("                     <label for = \"status\" style = \"font-size:30px; color:#F5FFFA;\">Status </label>\n");
      out.write("                    <select name=\"status\">\n");
      out.write("                        <option>Finished</option>\n");
      out.write("                        <option>Not Finished</option>\n");
      out.write("                       \n");
      out.write("                        \n");
      out.write("                    </select><br><br>\n");
      out.write("\n");
      out.write("                   <label for = \"price\" style = \"font-size:30px; color:#F5FFFA;\">Price </label>\n");
      out.write("                    <input type = \"text\" placeholder = \"Enter price\" name = \"price\" required><br>\n");
      out.write("\n");
      out.write("                    <button type = \"submit\" class=\"btn btn-primary\" name = \"user-register\" style=\"font-size: 20px; width: 50%;\"><b>Enter </b></button>\n");
      out.write("            </div>\n");
      out.write("        </form>\n");
      out.write("                  ");
    } catch (Throwable t) {
