...
<!-- Navigation Bar -->
        ...
        <p class = "heading"><b> Delivery Section</b></p>
        <table border="1" class="table table-hover" style="  color: white;width: 80%;">
            ...
            <tr>
                ...
                <td><%=price%></td>
                <td>
                    <form action="delete.jsp"><p hidden="hidden"><input type="text" name="user" value="<%=user%>"></p><input type="submit" value="Delete" onclick="f();"></form>
                </td>
